import {
    ...
    CornerUpLeft, CreditCard, Truck, TruckIcon, ShieldAlert, LayoutGrid, AlertCircle, XCircle, Settings, Database, Wrench
} from "lucide-react";
...
export const STAGES = [
    ...
    { num: 8, name: "Material Testing", slug: "material-testing", icon: ClipboardCheck },
    { num: 9, name: "Serial Generation", slug: "warranty-info", icon: ShieldAlert },
    { num: 9.5, name: "Warranty Claim", slug: "warranty-claim", icon: ShieldAlert },
    { num: 10, name: "Receipt in Tally", slug: "receipt-in-tally", icon: FileText },
    { num: 10.5, name: "Submit Invoice (HO)", slug: "submit-invoice-ho", icon: FileText },
    { num: 11, name: "Submit Invoice", slug: "submit-invoice", icon: Upload },
    { num: 12, name: "Verification by Accounts", slug: "verification", icon: ShieldCheck },
    { num: 12.5, name: "Repair Process", slug: "repair-process", icon: Wrench },
    { num: 13, name: "Purchase Return", slug: "purchase-return", icon: CornerUpLeft },
    { num: 14, name: "Return Approval", slug: "return-approval", icon: CornerUpLeft },
    { num: 15, name: "Vendor Payment", slug: "vendor-payment", icon: CreditCard },
    { num: 16, name: "Freight Payments", slug: "freight-payments", icon: Truck },
    { num: 17, name: "IMS", slug: "ims", icon: LayoutGrid },
    { num: 18, name: "Damaged Records", slug: "damaged-records", icon: AlertCircle },
    { num: 19, name: "Order Cancel", slug: "order-cancel", icon: XCircle },
    { num: 20, name: "Settings", slug: "settings", icon: Settings },
    { num: 21, name: "Master", slug: "master", icon: Database },
];
